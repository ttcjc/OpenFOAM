...
Foam::label Foam::KinematicParcelSC<ParcelType>::maxTrackAttempts = 1;
...
void Foam::KinematicParcelSC<ParcelType>::setCellValues
(
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicParcelSC<ParcelType>::calcDispersion
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicParcelSC<ParcelType>::cellValueSourceCorrection
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicParcelSC<ParcelType>::calc
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
const Foam::vector Foam::KinematicParcelSC<ParcelType>::calcVelocity
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt,
...
template<class ParcelType>
template<class TrackCloudType>
bool Foam::KinematicParcelSC<ParcelType>::move
(
    TrackCloudType& cloud,
    trackingData& td,
...
template<class ParcelType>
template<class TrackCloudType>
bool Foam::KinematicParcelSC<ParcelType>::hitPatch
(
    TrackCloudType& cloud,
    trackingData& td
)
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicParcelSC<ParcelType>::hitProcessorPatch
(
    TrackCloudType&,
    trackingData& td
)
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicParcelSC<ParcelType>::hitWallPatch
(
    TrackCloudType&,
    trackingData&
)
...
template<class ParcelType>
void Foam::KinematicParcelSC<ParcelType>::transformProperties(const tensor& T)
{
...
template<class ParcelType>
void Foam::KinematicParcelSC<ParcelType>::transformProperties
(
