...
void Foam::ParticleCollectorSC<CloudType>::makeLogFile
(
...
template<class CloudType>
void Foam::ParticleCollectorSC<CloudType>::initPolygons
(
...
template<class CloudType>
void Foam::ParticleCollectorSC<CloudType>::initConcentricCircles()
{
...
template<class CloudType>
void Foam::ParticleCollectorSC<CloudType>::collectParcelPolygon
(
    const point& p1,
    const point& p2
) const
...
template<class CloudType>
void Foam::ParticleCollectorSC<CloudType>::collectParcelConcentricCircles
(
    const point& p1,
    const point& p2
) const
...
template<class CloudType>
void Foam::ParticleCollectorSC<CloudType>::write()
{
...
template<class CloudType>
Foam::ParticleCollectorSC<CloudType>::ParticleCollectorSC
(
...
Foam::ParticleCollectorSC<CloudType>::ParticleCollectorSC
(
    const ParticleCollectorSC<CloudType>& pc
)
:
    CloudFunctionObjectSC<CloudType>(pc),
    mode_(pc.mode_),
...
template<class CloudType>
void Foam::ParticleCollectorSC<CloudType>::postMove
(
    parcelType& p,
    const scalar dt,
