...
Foam::label Foam::ParticleErosionSC<CloudType>::applyToPatch
(
...
template<class CloudType>
void Foam::ParticleErosionSC<CloudType>::write()
{
    if (QPtr_.valid())
    {
        QPtr_->write();
...
template<class CloudType>
Foam::ParticleErosionSC<CloudType>::ParticleErosionSC
(
...
Foam::ParticleErosionSC<CloudType>::ParticleErosionSC
(
    const ParticleErosionSC<CloudType>& pe
)
:
    CloudFunctionObjectSC<CloudType>(pe),
    QPtr_(nullptr),
...
template<class CloudType>
void Foam::ParticleErosionSC<CloudType>::preEvolve()
{
    if (QPtr_.valid())
    {
...
template<class CloudType>
void Foam::ParticleErosionSC<CloudType>::postPatch
(
    const parcelType& p,
    const polyPatch& pp,
    bool&
