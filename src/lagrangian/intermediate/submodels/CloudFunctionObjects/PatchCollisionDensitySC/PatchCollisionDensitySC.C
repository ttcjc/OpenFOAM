...
void Foam::PatchCollisionDensitySC<CloudType>::write()
{
...
template<class CloudType>
Foam::PatchCollisionDensitySC<CloudType>::PatchCollisionDensitySC
(
...
Foam::PatchCollisionDensitySC<CloudType>::PatchCollisionDensitySC
(
    const PatchCollisionDensitySC<CloudType>& ppm
)
:
...
template<class CloudType>
void Foam::PatchCollisionDensitySC<CloudType>::postPatch
(
    const parcelType& p,
    const polyPatch& pp,
    bool&
