...
Foam::ParticleTrapSC<CloudType>::ParticleTrapSC
(
...
Foam::ParticleTrapSC<CloudType>::ParticleTrapSC
(
    const ParticleTrapSC<CloudType>& pt
)
:
    CloudFunctionObjectSC<CloudType>(pt),
...
template<class CloudType>
void Foam::ParticleTrapSC<CloudType>::preEvolve()
{
...
template<class CloudType>
void Foam::ParticleTrapSC<CloudType>::postEvolve()
{
    gradAlphaPtr_.clear();
}
...
template<class CloudType>
void Foam::ParticleTrapSC<CloudType>::postMove
(
    parcelType& p,
    const scalar,
    const point&,
