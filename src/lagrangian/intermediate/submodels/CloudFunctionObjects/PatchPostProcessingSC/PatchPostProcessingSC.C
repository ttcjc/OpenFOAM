...
Foam::label Foam::PatchPostProcessingSC<CloudType>::applyToPatch
(
...
template<class CloudType>
void Foam::PatchPostProcessingSC<CloudType>::write()
{
    forAll(patchData_, i)
    {
...
template<class CloudType>
Foam::PatchPostProcessingSC<CloudType>::PatchPostProcessingSC
(
...
Foam::PatchPostProcessingSC<CloudType>::PatchPostProcessingSC
(
    const PatchPostProcessingSC<CloudType>& ppm
)
:
...
template<class CloudType>
void Foam::PatchPostProcessingSC<CloudType>::postPatch
(
    const parcelType& p,
    const polyPatch& pp,
    bool&
