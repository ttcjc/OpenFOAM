...
void Foam::FacePostProcessingSC<CloudType>::makeLogFile
(
    const word& zoneName,
    const label zoneI,
    const label nFaces,
...
template<class CloudType>
void Foam::FacePostProcessingSC<CloudType>::write()
{
...
template<class CloudType>
Foam::FacePostProcessingSC<CloudType>::FacePostProcessingSC
(
...
Foam::FacePostProcessingSC<CloudType>::FacePostProcessingSC
(
    const FacePostProcessingSC<CloudType>& pff
)
:
    CloudFunctionObjectSC<CloudType>(pff),
...
template<class CloudType>
void Foam::FacePostProcessingSC<CloudType>::postFace(const parcelType& p, bool&)
{
    if
    (
