...
void Foam::ParticleTracksSC<CloudType>::write()
{
    if (cloudPtr_.valid())
    {
        cloudPtr_->write();
...
template<class CloudType>
Foam::ParticleTracksSC<CloudType>::ParticleTracksSC
(
...
template<class CloudType>
void Foam::ParticleTracksSC<CloudType>::preEvolve()
{
    if (!cloudPtr_.valid())
    {
        cloudPtr_.reset
...
template<class CloudType>
void Foam::ParticleTracksSC<CloudType>::postFace(const parcelType& p, bool&)
{
    if
    (
