...
// CJC {
template<class CloudType>
void Foam::ReactingMultiphaseLookupTableInjection<CloudType>::setPositionAndCellTP
(
	const label,
    const label,
    const scalar,
...
// CJC {
template<class CloudType>
void Foam::ReactingMultiphaseLookupTableInjection<CloudType>::setPropertiesTP
(
    const label,
