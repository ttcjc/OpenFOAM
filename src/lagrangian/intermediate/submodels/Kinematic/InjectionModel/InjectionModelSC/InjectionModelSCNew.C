...
Foam::autoPtr<Foam::InjectionModelSC<CloudType>>
Foam::InjectionModelSC<CloudType>::New
(
...
)
{
    ...
    return autoPtr<InjectionModelSC<CloudType>>(cstrIter()(dict, owner));
}
...
)
{
    ...
    return
        autoPtr<InjectionModelSC<CloudType>>
        (
            cstrIter()
            (
                dict,
