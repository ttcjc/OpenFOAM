...
bool Foam::InjectionModelSC<CloudType>::prepareForNextTimeStep
(
    const scalar time,
    label& newParcels,
...
template<class CloudType>
bool Foam::InjectionModelSC<CloudType>::findCellAtPosition
(
    label& celli,
    label& tetFacei,
    label& tetPti,
...
template<class CloudType>
Foam::scalar Foam::InjectionModelSC<CloudType>::setNumberOfParticles
(
    const label parcels,
...
template<class CloudType>
void Foam::InjectionModelSC<CloudType>::postInjectCheck
(
...
template<class CloudType>
Foam::InjectionModelSC<CloudType>::InjectionModelSC(CloudType& owner)
:
...
template<class CloudType>
Foam::InjectionModelSC<CloudType>::InjectionModelSC
(
...
Foam::InjectionModelSC<CloudType>::InjectionModelSC
(
    const InjectionModelSC<CloudType>& im
)
:
...
template<class CloudType>
void Foam::InjectionModelSC<CloudType>::updateMesh()
{}


template<class CloudType>
Foam::scalar Foam::InjectionModelSC<CloudType>::averageParcelMass()
{
    label nTotal = 0.0;
...
void Foam::InjectionModelSC<CloudType>::inject
(
...
template<class CloudType>
template<class TrackCloudType>
void Foam::InjectionModelSC<CloudType>::injectSteadyState
(
    TrackCloudType& cloud,
    typename CloudType::parcelType::trackingData& td,
...
template<class CloudType>
void Foam::InjectionModelSC<CloudType>::info(Ostream& os)
{
