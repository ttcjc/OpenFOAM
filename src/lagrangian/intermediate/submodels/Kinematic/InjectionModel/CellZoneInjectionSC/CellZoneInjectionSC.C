...
void Foam::CellZoneInjectionSC<CloudType>::setPositions
(
...
template<class CloudType>
Foam::CellZoneInjectionSC<CloudType>::CellZoneInjectionSC
(
...
Foam::CellZoneInjectionSC<CloudType>::CellZoneInjectionSC
(
    const CellZoneInjectionSC<CloudType>& im
)
:
...
template<class CloudType>
void Foam::CellZoneInjectionSC<CloudType>::updateMesh()
{
...
template<class CloudType>
Foam::scalar Foam::CellZoneInjectionSC<CloudType>::timeEnd() const
{
    // Not used
    return this->SOI_;
}
...
template<class CloudType>
Foam::label Foam::CellZoneInjectionSC<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::CellZoneInjectionSC<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::CellZoneInjectionSC<CloudType>::setPositionAndCell
(
    const label parcelI,
...
template<class CloudType>
void Foam::CellZoneInjectionSC<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
bool Foam::CellZoneInjectionSC<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::CellZoneInjectionSC<CloudType>::validInjection(const label)
{
    return true;
}
