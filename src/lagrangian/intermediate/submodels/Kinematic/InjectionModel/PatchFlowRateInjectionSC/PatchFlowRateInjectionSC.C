...
#include "PatchFlowRateInjectionSC.H"
...
Foam::PatchFlowRateInjectionSC<CloudType>::PatchFlowRateInjectionSC
(
...
Foam::PatchFlowRateInjectionSC<CloudType>::PatchFlowRateInjectionSC
(
    const PatchFlowRateInjectionSC<CloudType>& im
)
:
...
template<class CloudType>
void Foam::PatchFlowRateInjectionSC<CloudType>::updateMesh()
{
...
template<class CloudType>
Foam::scalar Foam::PatchFlowRateInjectionSC<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::scalar Foam::PatchFlowRateInjectionSC<CloudType>::flowRate() const
{
...
template<class CloudType>
Foam::label Foam::PatchFlowRateInjectionSC<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::PatchFlowRateInjectionSC<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::PatchFlowRateInjectionSC<CloudType>::setPositionAndCell
(
    const label,
    const label,
    const scalar,
...
template<class CloudType>
void Foam::PatchFlowRateInjectionSC<CloudType>::setProperties
(
    const label,
    const label,
    const scalar,
...
template<class CloudType>
bool Foam::PatchFlowRateInjectionSC<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::PatchFlowRateInjectionSC<CloudType>::validInjection(const label)
{
    return true;
}
