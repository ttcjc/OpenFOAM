...
#include "FieldActivatedInjectionSC.H"
#include "volFields.H"
...
Foam::FieldActivatedInjectionSC<CloudType>::FieldActivatedInjectionSC
(
...
Foam::FieldActivatedInjectionSC<CloudType>::FieldActivatedInjectionSC
(
    const FieldActivatedInjectionSC<CloudType>& im
)
:
...
template<class CloudType>
void Foam::FieldActivatedInjectionSC<CloudType>::updateMesh()
{
...
template<class CloudType>
Foam::scalar Foam::FieldActivatedInjectionSC<CloudType>::timeEnd() const
{
    return great;
}
...
template<class CloudType>
Foam::label Foam::FieldActivatedInjectionSC<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::FieldActivatedInjectionSC<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::FieldActivatedInjectionSC<CloudType>::setPositionAndCell
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
void Foam::FieldActivatedInjectionSC<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
bool Foam::FieldActivatedInjectionSC<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::FieldActivatedInjectionSC<CloudType>::validInjection
(
    const label parcelI
)
{
