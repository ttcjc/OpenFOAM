...
#include "InflationInjectionSC.H"
...
Foam::InflationInjectionSC<CloudType>::InflationInjectionSC
(
...
Foam::InflationInjectionSC<CloudType>::InflationInjectionSC
(
    const Foam::InflationInjectionSC<CloudType>& im
)
:
...
template<class CloudType>
void Foam::InflationInjectionSC<CloudType>::updateMesh()
{}


template<class CloudType>
Foam::scalar Foam::InflationInjectionSC<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::InflationInjectionSC<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::InflationInjectionSC<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::InflationInjectionSC<CloudType>::setPositionAndCell
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
void Foam::InflationInjectionSC<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
bool Foam::InflationInjectionSC<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::InflationInjectionSC<CloudType>::validInjection(const label)
{
    return true;
}
