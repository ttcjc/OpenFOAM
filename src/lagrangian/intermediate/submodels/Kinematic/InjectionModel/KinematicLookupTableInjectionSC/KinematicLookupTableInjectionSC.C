...
#include "KinematicLookupTableInjectionSC.H"
#include "scalarIOList.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::KinematicLookupTableInjectionSC<CloudType>::KinematicLookupTableInjectionSC
(
...
Foam::KinematicLookupTableInjectionSC<CloudType>::KinematicLookupTableInjectionSC
(
    const KinematicLookupTableInjectionSC<CloudType>& im
)
:
...
template<class CloudType>
void Foam::KinematicLookupTableInjectionSC<CloudType>::updateMesh()
{
    // Set/cache the injector cells
    forAll(injectors_, i)
    {
...
template<class CloudType>
Foam::scalar Foam::KinematicLookupTableInjectionSC<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::KinematicLookupTableInjectionSC<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::KinematicLookupTableInjectionSC<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::KinematicLookupTableInjectionSC<CloudType>::setPositionAndCell
(
    const label parcelI,
...
template<class CloudType>
void Foam::KinematicLookupTableInjectionSC<CloudType>::setProperties
(
    const label parcelI,
    const label nParcels,
    const scalar,
...
template<class CloudType>
bool Foam::KinematicLookupTableInjectionSC<CloudType>::fullyDescribed() const
{
    return true;
}
...
template<class CloudType>
bool Foam::KinematicLookupTableInjectionSC<CloudType>::validInjection
(
    const label
)
{
