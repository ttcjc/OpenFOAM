...
void Foam::ConeInjectionSC<CloudType>::setInjectionMethod()
{
...
template<class CloudType>
void Foam::ConeInjectionSC<CloudType>::setFlowType()
{
    const word flowType =
        this->coeffDict().template lookupOrDefault<word>
        (
...
template<class CloudType>
Foam::ConeInjectionSC<CloudType>::ConeInjectionSC
(
...
Foam::ConeInjectionSC<CloudType>::ConeInjectionSC
(
    const ConeInjectionSC<CloudType>& im
)
:
...
template<class CloudType>
void Foam::ConeInjectionSC<CloudType>::updateMesh()
{
...
template<class CloudType>
Foam::scalar Foam::ConeInjectionSC<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::ConeInjectionSC<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::ConeInjectionSC<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::ConeInjectionSC<CloudType>::setPositionAndCell
(
    const label parcelI,
    const label,
    const scalar time,
...
template<class CloudType>
void Foam::ConeInjectionSC<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar time,
...
template<class CloudType>
bool Foam::ConeInjectionSC<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::ConeInjectionSC<CloudType>::validInjection(const label)
{
    return true;
}
