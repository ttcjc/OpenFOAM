...
Foam::ManualInjectionSC<CloudType>::ManualInjectionSC
(
...
Foam::ManualInjectionSC<CloudType>::ManualInjectionSC
(
    const ManualInjectionSC<CloudType>& im
)
:
...
template<class CloudType>
void Foam::ManualInjectionSC<CloudType>::updateMesh()
{
    label nRejected = 0;
...
template<class CloudType>
Foam::scalar Foam::ManualInjectionSC<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::ManualInjectionSC<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::ManualInjectionSC<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::ManualInjectionSC<CloudType>::setPositionAndCell
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
void Foam::ManualInjectionSC<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
bool Foam::ManualInjectionSC<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::ManualInjectionSC<CloudType>::validInjection(const label)
{
    return true;
}
