...
#include "patchInjectionSCBase.H"
#include "polyMesh.H"
#include "SubField.H"
#include "Random.H"
...
Foam::patchInjectionSCBase::patchInjectionSCBase
(
    const polyMesh& mesh,
...
Foam::patchInjectionSCBase::patchInjectionSCBase(const patchInjectionSCBase& pib)
:
...
void Foam::patchInjectionSCBase::updateMesh(const polyMesh& mesh)
{
...
void Foam::patchInjectionSCBase::setPositionAndCell
(
    const fvMesh& mesh,
    Random& rnd,
    vector& position,
