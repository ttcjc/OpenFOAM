...
void Foam::KinematicCloudSC<CloudType>::setModels()
{
    dispersionModel_.reset
    (
        DispersionModel<KinematicCloudSC<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        PatchInteractionModel<KinematicCloudSC<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        StochasticCollisionModel<KinematicCloudSC<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        SurfaceFilmModel<KinematicCloudSC<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
...
void Foam::KinematicCloudSC<CloudType>::solve
(
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::buildCellOccupancy()
{
    ...
    forAllIter(typename KinematicCloudSC<CloudType>, *this, iter)
    {
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::updateCellOccupancy()
{
...
template<class CloudType>
template<class TrackCloudType>
void Foam::KinematicCloudSC<CloudType>::evolveCloud
(
    TrackCloudType& cloud,
    typename parcelType::trackingData& td
)
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::cloudReset(KinematicCloudSC<CloudType>& c)
{
...
template<class CloudType>
Foam::KinematicCloudSC<CloudType>::KinematicCloudSC
(
...
(
    const fvMesh& mesh,
    const word& name,
    const KinematicCloudSC<CloudType>& c
)
:
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::setParcelThermoProperties
(
    parcelType& parcel,
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::checkParcelProperties
(
    parcelType& parcel,
    const scalar lagrangianDt,
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::storeState()
{
    cloudCopyPtr_.reset
    (
        static_cast<KinematicCloudSC<CloudType>*>
        (
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::restoreState()
{
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::resetSourceTerms()
{
    UTrans().field() = Zero;
    UCoeff().field() = 0.0;
}
...
template<class CloudType>
template<class Type>
void Foam::KinematicCloudSC<CloudType>::relax
(
...
template<class CloudType>
template<class Type>
void Foam::KinematicCloudSC<CloudType>::scale
(
    DimensionedField<Type, volMesh>& field,
    const word& name
) const
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::relaxSources
(
    const KinematicCloudSC<CloudType>& cloudOldTime
)
{
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::scaleSources()
{
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::preEvolve()
{
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::evolve()
{
...
template<class CloudType>
template<class TrackCloudType>
void Foam::KinematicCloudSC<CloudType>::motion
(
    TrackCloudType& cloud,
    typename parcelType::trackingData& td
)
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::patchData
(
    const parcelType& p,
    const polyPatch& pp,
    vector& nw,
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::updateMesh()
{
    updateCellOccupancy();
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::autoMap(const mapPolyMesh& mapper)
{
    CloudSC<parcelType>::autoMap(mapper);
...
template<class CloudType>
void Foam::KinematicCloudSC<CloudType>::info()
{
