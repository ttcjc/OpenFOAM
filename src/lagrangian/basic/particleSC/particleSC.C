...
const Foam::label Foam::particleSC::maxNBehind_ = 10;

Foam::label Foam::particleSC::particleCount_ = 0;

namespace Foam
{
    defineTypeNameAndDebug(particleSC, 0);
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::particleSC::stationaryTetReverseTransform
(
    vector& centre,
    scalar& detA,
    barycentricTensor& T
...
void Foam::particleSC::movingTetReverseTransform
(
...
void Foam::particleSC::reflect()
{
    Swap(coordinates_.c(), coordinates_.d());
}


void Foam::particleSC::rotate(const bool reverse)
{
    if (!reverse)
    {
...
void Foam::particleSC::changeTet(const label tetTriI)
{
    if (debug)
    {
...
void Foam::particleSC::changeFace(const label tetTriI)
{
    if (debug)
    {
        Info << "Particle " << origId() << nl << FUNCTION_NAME << nl << endl;
...
void Foam::particleSC::changeCell()
{
    if (debug)
    {
        Info << "Particle " << origId() << nl << FUNCTION_NAME << nl << endl;
...
void Foam::particleSC::changeToMasterPatch()
{
    if (debug)
    {
        Info << "Particle " << origId() << nl << FUNCTION_NAME << nl << endl;
...
Foam::particleSC::particleSC(const particleSC& p)
:
    mesh_(p.mesh_),
...
Foam::particleSC::particleSC(const particleSC& p, const polyMesh& mesh)
:
    mesh_(mesh),
    coordinates_(p.coordinates_),
    celli_(p.celli_),
...
Foam::scalar Foam::particleSC::track
(
...
Foam::scalar Foam::particleSC::trackToCell
(
    const vector& displacement,
    const scalar fraction
)
...
Foam::scalar Foam::particleSC::trackToFace
(
    const vector& displacement,
    const scalar fraction
)
...
Foam::scalar Foam::particleSC::trackToStationaryTri
(
    const vector& displacement,
    const scalar fraction,
    label& tetTriI
...
Foam::scalar Foam::particleSC::trackToMovingTri
(
    const vector& displacement,
    const scalar fraction,
    label& tetTriI
...
Foam::scalar Foam::particleSC::trackToTri
(
    const vector& displacement,
    const scalar fraction,
    label& tetTriI
...
Foam::vector Foam::particleSC::deviationFromMeshCentre() const
{
...
void Foam::particleSC::transformProperties(const tensor&)
{}


void Foam::particleSC::transformProperties(const vector&)
{}


void Foam::particleSC::prepareForParallelTransfer()
{
...
void Foam::particleSC::correctAfterParallelTransfer
(
    const label patchi,
    trackingData& td
)
...
void Foam::particleSC::prepareForInteractionListReferral
(
...
void Foam::particleSC::correctAfterInteractionListReferral(const label celli)
{
...
Foam::label Foam::particleSC::procTetPt
(
...
bool Foam::operator==(const particleSC& pA, const particleSC& pB)
{
