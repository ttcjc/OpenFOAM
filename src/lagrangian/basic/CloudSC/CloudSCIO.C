...
Foam::word Foam::CloudSC<ParticleType>::cloudPropertiesName("cloudProperties");


// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

template<class ParticleType>
void Foam::CloudSC<ParticleType>::readCloudUniformProperties()
{
    IOobject dictObj
    (
        cloudPropertiesName,
...
template<class ParticleType>
void Foam::CloudSC<ParticleType>::writeCloudUniformProperties() const
{
...
template<class ParticleType>
void Foam::CloudSC<ParticleType>::initCloud(const bool checkClass)
{
    readCloudUniformProperties();

    IOPositionSC<CloudSC<ParticleType>> ioP(*this);
...
template<class ParticleType>
Foam::IOobject Foam::CloudSC<ParticleType>::fieldIOobject
(
...
void Foam::CloudSC<ParticleType>::checkFieldIOobject
(
...
template<class ParticleType>
template<class DataType>
void Foam::CloudSC<ParticleType>::checkFieldFieldIOobject
(
    const CloudSC<ParticleType>& c,
...
template<class ParticleType>
void Foam::CloudSC<ParticleType>::writeFields() const
{
...
template<class ParticleType>
bool Foam::CloudSC<ParticleType>::writeObject
(
...
template<class ParticleType>
Foam::Ostream& Foam::operator<<(Ostream& os, const CloudSC<ParticleType>& pc)
{
    pc.writeData(os);

    // Check state of Ostream
    os.check("Ostream& operator<<(Ostream&, const CloudSC<ParticleType>&)");
